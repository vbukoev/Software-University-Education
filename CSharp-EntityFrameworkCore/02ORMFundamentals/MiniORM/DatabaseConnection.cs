namespace MiniORM
{
	...
	internal class DatabaseConnection
	{
		...
		/// <summary>
		/// Returns all columns names for given table. 
		/// </summary>
		...
		public IEnumerable<T> ExecuteQuery<T>(string queryText)
		{
			...
			while (reader.Read())
			{
				var columnValuesObjects = new object[reader.FieldCount];
				reader.GetValues(columnValuesObjects);
		...
		/// <summary>
		/// Auto-Generate INSERT SQL Query
		/// </summary>
		...
		/// <summary>
		/// Auto-Generate UPDATE SQL Query
		/// </summary>
		/// <typeparam name="T"></typeparam>
		...
		/// <summary>
		/// Auto-Generate DELETE SQL Query
		/// </summary>
		/// <typeparam name="T"></typeparam>
