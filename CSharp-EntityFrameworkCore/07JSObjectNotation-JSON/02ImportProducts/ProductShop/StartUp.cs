...
namespace ProductShop
{
    ...
    {
        //if you want your solution to work for judge you have to add this in the Data/ProductShopContext.cs:
        ...
        public static void Main()
        {
            ...
            string output = ImportProducts(context, inputJsonProducts); 
