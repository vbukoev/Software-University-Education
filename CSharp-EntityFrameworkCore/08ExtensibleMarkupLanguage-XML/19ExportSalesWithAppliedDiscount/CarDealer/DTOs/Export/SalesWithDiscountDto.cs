...
namespace CarDealer.DTOs.Export
{
    ...
    {
        [XmlElement("car")] public SingleCar SingleCar { get; set; }
        [XmlElement("discount")] public int Discount { get; set; }
        [XmlElement("customer-name")] public string CustomerName { get; set; }
        [XmlElement("price")] public decimal Price { get; set; }
        [XmlElement("price-with-discount")] public double PriceWithDiscount { get; set; }
    }
    ...
    public class SingleCar
    {
        ...
        [XmlAttribute("traveled-distance")] public long TraveledDistance { get; set; }
    }
}
