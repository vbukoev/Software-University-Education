    ...
    public static class Deserializer
    {
        ...
        public static string ImportGames(VaporStoreDbContext context, string jsonString)
        {
            ...
            foreach (var gameDto in gamesDtos)
            {
                ...
                if (!IsValid(gameDto) || String.IsNullOrEmpty(gameDto.Name) || gameDto.Price < 0 || !isReleaseDateValid || !gameDto.Tags.Any() || String.IsNullOrEmpty(gameDto.Genre) || String.IsNullOrEmpty(gameDto.Developer))
                {
                ...
                Genre genre = genres.Find(x => x.Name == gameDto.Genre);
                if (genre == null)
                {
                    genre = new Genre()
                    {
                ...
                Developer developer = developers.Find(x => x.Name == gameDto.Developer);
        ...
        public static string ImportUsers(VaporStoreDbContext context, string jsonString)
        {
            ...
            {
                if (!IsValid(userDto) || string.IsNullOrEmpty(userDto.Email) || !userDto.Cards.Any())
                {
                    sb.AppendLine(ErrorMessage);
                    continue;
                }
                ...
                List<Card> currCards = new List<Card>();
                ...
                foreach (var cardDto in userDto.Cards)
                {
                    ...
                    Card card = cards.Find(x => x.Number == cardDto.Number);
                    if (card == null)
                    {
                        card = new Card
                        {
