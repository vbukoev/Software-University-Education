...
namespace _04AddMinion
{
    public class StartUp
    {
        ...
        {
           var minionsInfo = Console.ReadLine().Split(new string[] { "Minion: ", " " }, StringSplitOptions.RemoveEmptyEntries)
               .ToArray();
           var minionName = minionsInfo[0];
           var minionAge = int.Parse(minionsInfo[1]);
           var minionTown = minionsInfo[2];
           var villainName = Console.ReadLine().Split("Villain: ", StringSplitOptions.RemoveEmptyEntries)
               .ToArray()[0];
